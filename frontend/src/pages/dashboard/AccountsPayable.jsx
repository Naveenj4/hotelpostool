                ...
                <div className="master-content-layout fade-in">
                    <div className="master-header-premium">
                        <div className="master-title-premium">
                            <div className="flex items-center gap-2 mb-2">
                                <ArrowUpFromLine className="text-red-600" size={18} />
                                <span className="text-[10px] font-black text-red-600 uppercase tracking-widest bg-red-50 px-2.5 py-1 rounded-full">Payables</span>
                            </div>
                            <h2>Accounts Payable Aging</h2>
                            <p>Detailed temporal analysis of pending capital outflow commitments.</p>
                        </div>
                    ...
                    <div className="toolbar-premium">
                        <div className="flex gap-4 items-center w-full justify-between">
                            ...
                            <div className="text-right border-l pl-6 border-slate-200">
                                <div className="text-xs font-black text-slate-400 uppercase tracking-widest">Total Liability</div>
                                <div className="text-2xl font-black text-red-600">₹{totalPayable.toLocaleString('en-IN', { maximumFractionDigits: 2 })}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    {loading ? (
                        <div className="flex flex-col items-center justify-center p-20">
                            ...
                            <p className="text-slate-400 font-bold tracking-widest uppercase text-xs">Processing Liabilities Matrix...</p>
                        </div>
                    ) : (
