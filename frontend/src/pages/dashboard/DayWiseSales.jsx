        ...
        <div className={`dashboard-content fade-in ${isEmbedded ? 'p-0 pb-32' : 'p-6 lg:p-14 pb-24'} max-w-[2000px] mx-auto w-full`}>
            ...
            <div className={`flex flex-col xl:flex-row justify-between items-end xl:items-center ${isEmbedded ? 'mb-8 border-b border-slate-50 pb-6' : 'mb-16 border-b border-slate-100 pb-10'} gap-8`}>
                <div>
                    ...
                    <h2 className="premium-page-title mb-3">Day-Wise Summary</h2>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10 ${isEmbedded ? 'mb-10' : 'mb-20'}`}>
                <div className="group">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                        <Target size={12} className="text-indigo-500" /> Period Bill Reg
                    </p>
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-slate-900 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>{summary.totalBills}</h4>
                ...
                <div className="group">
                    ...
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-slate-900 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>₹{fmt(summary.cash)}</h4>
                ...
                <div className="group">
                    ...
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-slate-900 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>₹{fmt(summary.card)}</h4>
                ...
                <div className="group">
                    ...
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-slate-900 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>₹{fmt(summary.upi)}</h4>
                ...
                <div className={`group ${isEmbedded ? '' : 'lg:pl-10 lg:border-l border-slate-100'}`}>
                    ...
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-rose-600 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>₹{fmt(summary.credit)}</h4>
                    <div className="h-1 w-12 bg-rose-500 rounded-full opacity-20 group-hover:opacity-100 transition-opacity"></div>
                </div>
            </div>

            {/* Action Tool Hub */}
            <div className={`flex flex-wrap items-center justify-end gap-4 ${isEmbedded ? 'mb-6' : 'mb-10'}`}>
