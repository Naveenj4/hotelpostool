                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="form-group-premium col-span-1 md:col-span-2 !mb-0">
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <input type="text" name="name" required className="input-premium-modern !pl-12 w-full font-bold uppercase" placeholder="e.g. ACME SOLUTIONS PVT LTD" value={formData.name} onChange={handleChange} />
                                                </div>
                                            </div>
                                            <div className="form-group-premium !mb-0"><label>Phone Number</label><div className="relative group"><Phone size={15} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-indigo-500 transition-colors" /><input type="text" name="phone" className="input-premium-modern !pl-11 w-full font-semibold" placeholder="+91" value={formData.phone} onChange={handleChange} /></div></div>
                                            <div className="form-group-premium !mb-0"><label>Email Protocol</label><div className="relative group"><Mail size={15} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-indigo-500 transition-colors" /><input type="email" name="email" className="input-premium-modern !pl-11 w-full font-semibold" placeholder="office@domain.com" value={formData.email} onChange={handleChange} /></div></div>
                                            <div className="form-group-premium !mb-0"><label>GSTIN Identifier</label><div className="relative group"><Hash size={15} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-indigo-500 transition-colors" /><input type="text" name="gstin" className="input-premium-modern !pl-11 w-full font-semibold uppercase" placeholder="27AAAAA0000A1Z5" value={formData.gstin} onChange={handleChange} /></div></div>
                                            <div className="form-group-premium !mb-0"><label>PAN Certificate</label><div className="relative group"><CreditCard size={15} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-indigo-500 transition-colors" /><input type="text" name="pan_number" className="input-premium-modern !pl-11 w-full font-semibold uppercase" placeholder="ABCDE1234F" value={formData.pan_number} onChange={handleChange} /></div></div>
                                        </div>
