        ...
        <div className={`dashboard-content fade-in ${isEmbedded ? 'p-0 pb-32' : 'p-6 lg:p-14 pb-24'} max-w-[2000px] mx-auto w-full`}>
            ...
            <div className={`flex flex-col xl:flex-row justify-between items-end xl:items-center ${isEmbedded ? 'mb-8 border-b border-slate-50 pb-6' : 'mb-16 border-b border-slate-100 pb-10'} gap-8`}>
                <div>
                    ...
                    <h2 className={`${isEmbedded ? 'text-3xl' : 'text-5xl'} font-black text-slate-900 tracking-[-0.04em] mb-3 uppercase`}>Stock Sales Matrix</h2>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10 ${isEmbedded ? 'mb-10' : 'mb-20'}`}>
                <div className="group">
                    ...
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-slate-900 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>{summary.totalItems}</h4>
                ...
                <div className="group">
                    ...
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-slate-900 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>{summary.salesQty}</h4>
                ...
                <div className="group">
                    ...
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-rose-600 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>{summary.returnQty}</h4>
                ...
                <div className="group">
                    ...
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-slate-900 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>{summary.totalSalesQty}</h4>
                ...
                <div className={`group ${isEmbedded ? '' : 'lg:pl-10 lg:border-l border-slate-100'}`}>
                    ...
                    <h4 className={`${isEmbedded ? 'text-2xl' : 'text-4xl'} font-black text-slate-900 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform`}>₹{fmt(summary.salesValue)}</h4>
