                ...
                <div className="dashboard-content fade-in p-6 lg:p-14 max-w-[2000px] mx-auto w-full">
                    ...
                    <div className="flex flex-col xl:flex-row justify-between items-end xl:items-center mb-16 gap-8 border-b border-slate-100 pb-10">
                        <div>
                            ...
                            <h2 className="text-5xl font-black text-slate-900 tracking-[-0.04em] mb-3 uppercase">Margin Intelligence</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
                        <div className="group">
                            ...
                            <h4 className="text-4xl font-black text-slate-900 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform">₹{fmt(summary.totalSales)}</h4>
                        ...
                        <div className="group">
                            ...
                            <h4 className="text-4xl font-black text-rose-600 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform">₹{fmt(summary.return)}</h4>
                        ...
                        <div className="group lg:pl-10 lg:border-l border-slate-100">
                            ...
                            <h4 className="text-4xl font-black text-emerald-600 tracking-tighter mb-2 group-hover:translate-x-1 transition-transform">₹{fmt(summary.salesProfit)}</h4>
